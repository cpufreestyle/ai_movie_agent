"""Download Wan2.2 VAE (1.3GB) from QuantStack via hf-mirror, resilient."""
import os
import sys
import time
...
SRC = "VAE/Wan2.2_VAE.safetensors"
DST = r"D:\ComfyUI\models\vae\Wan2.2_VAE.safetensors"
CHUNK = 8 * 1024 * 1024
ROUNDS = 20
...
def main():
    ...
    for round_n in range(1, ROUNDS + 1):
        ...
        try:
            ...
            time.sleep(45)
            continue
        log(f"[SRC ] {SRC} ({total/1e9:.2f} GB)", flush=True)
